...
server.on("error", (err) => {
  if (err && err.code === "EADDRINUSE") {
    ...
    console.error(
      "If you are using VS Code Live Server (often 5500), stop it or run this server on a different port."
    );
    console.error("Example: set PORT=4000 then run: node server.js\n");
    process.exit(1);
  }
